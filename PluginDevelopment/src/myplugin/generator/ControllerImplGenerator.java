...
public class ControllerImplGenerator extends BasicGenerator {
	
	public ControllerImplGenerator(GeneratorOptions generatorOptions, List<TypeMapping> typeMappings) {
