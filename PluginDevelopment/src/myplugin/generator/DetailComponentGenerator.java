...
public class DetailComponentGenerator extends BasicGenerator{
	public DetailComponentGenerator(GeneratorOptions generatorOptions, List<TypeMapping> typeMappings) {
