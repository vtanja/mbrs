...
public class DTODetailImplGenerator extends BasicGenerator{
	public DTODetailImplGenerator(GeneratorOptions generatorOptions, List<TypeMapping> typeMappings) {
